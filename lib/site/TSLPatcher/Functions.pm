...
my %Messages = (
    ...
    # Miscellaneous
    LS_GUI_CONFIGMISSING =>
      'WARNING! Cannot locate the INI file "%s1" with work instructions!',
    ...
    LS_GUI_REPLOGLEVEL3    =>
      'Log level: 3 - Standard: Progress, errors and warnings.',
    LS_GUI_REPLOGLEVEL4 =>
      'Log level: 4 - Debug: Detailed progress, errors and warnings.',
    LS_GUI_REPTLKAPPEND   => 'dialog tlk appending',
    LS_GUI_REPNEWTLKCOUNT => 'New entries',
    LS_GUI_REP2DATITLE    => '2DA file changes',
    LS_GUI_REP2DAFILE     =>
      '%s1 - new rows: %s2, modified rows: %s3, new columns: %s4',
    ...
    LS_LOG_TLKSUMMARY1    =>
      '%s1 file updated with %s2 new entries, %s3 entries already existed.',
    ...
    LS_LOG_INSBACKUPFILE =>
      'Saving unaltered backup copy of destination file %s1 in %s2.',
    ...
    LS_LOG_INSREPLACERENAME =>
      'Renaming and replacing file "%s1" to "%s2" in the %s folder...',
    LS_LOG_INSREPLACE => 'Replacing file %s1 in the %s2 folder...',
    LS_LOG_INSLASKIP  =>
      'A file named %s1 already exists in the %s2 folder. Skipping file...',
    LS_LOG_INSRENAMECOPY =>
      'Renaming and copying file "%s1" to "%s2" to the %s3 folder...',
    LS_LOG_INSCOPYFILE          => 'Copying file %s1 to the %s2 folder...',
    LS_LOG_INSREPLACERENAMEFILE =>
      'Renaming and replacing file "%s1" to "%s2" in the %s3 archive...',
    LS_LOG_INSREPLACEFILE   => 'Replacing file %s1 in the %s2 archive...',
    LS_LOG_INSEXCEPTIONSKIP => '%s Skipping...',
    LS_LOG_INSLASKIPFILE    =>
      'A file named %s1 already exists in the %s2 archive. Skipping file...',
    LS_LOG_INSRENAMEADDFILE =>
      'Renaming and adding file "%s1" to "%s2" in the %s3 archive...',
    LS_LOG_INSADDFILE     => 'Adding file %s1 to the %s2 archive...',
    LS_LOG_INSCOPYFAILED  => 'Unable to copy file "%s1", file does not exist!',
    LS_LOG_INSNOMODIFIERS =>
      'No install instructions (%s1) found for folder %s2.',
    LS_LOG_INSINVALIDDESTINATION =>
      'Invalid install location "%s1" encountered! Skipping...',

    # 2DA Handler
    LS_LOG_2DAFILENOTFOUND =>
      'Unable to find 2DA file "%s1" to modify! Skipping file...',
    LS_LOG_2DAINVALIDMODIFIER =>
      'Invalid modifier type "%s1" found for modifier label "%s2". Skipping...',
    ...
    LS_LOG_EXCLUSIVECOLINVALID =>
      'Invalid Exclusive column label "%s1" specified, ignoring...',
    ...
    LS_LOG_2DAHIGHTOKENRLFOUND =>
      'Setting row label to next HIGHEST value %s1.',
    LS_LOG_2DAADDINGROW => 'Adding new row (index %s1) to 2DA file %s2...',
    LS_LOG_2DASETROWLABELERROR =>
      'Unable to set new row label "%s1" in modifier + "%s2"!',
    LS_LOG_2DAHIGHTOKENVALUE =>
      'Setting added row column %s1 to next HIGHEST value %s2.',
    ...
    LS_LOG_2DANEWROWLABELHIGH =>
      'Setting new row label to next HIGHEST value %s1.',
    ...
    LS_LOG_TOKENERROR1 =>
      'Invalid 2DAMEMORY token found! Token indexes start at 1 and go up...',
    LS_LOG_TOKENERROR2 =>
      'Invalid memory token %s1 encountered, using first memory slot instead.',
    LS_LOG_TOKENFOUND =>
      'Found a %s1 token! Storing value "%s2" from 2da to memory...',
    ...
    LS_LOG_TOKENCOLLABELERROR =>
      'Error looking up column label for column index %s1',
    LS_LOG_INVALIDCOLLABEL  => 'Invalid column label passed to %s1 key!',
    LS_LOG_TOKENROWLERROR   => 'Invalid row label "%s1" passed to %s2 key!',
    LS_LOG_LINDEXTOKENFOUND =>
      'Found a %s1 token! Storing ListIndex "%s2" from GFF to memory...',
    LS_LOG_FPATHTOKENFOUND =>
      'Found a %s1 token! Storing Field Path "%s2" from GFF to memory...',
    ...
    LS_LOG_GFFNOINSTRUCTION =>
      'No instruction section found for file %s1, skipping...',
    LS_LOG_GFFMODIFYINGFILE   => 'Modifying GFF file %s1...',
    LS_LOG_GFFBLANKFIELDLABEL =>
      'Blank Gff Field Label encountered in instructions, skipping...',
    LS_LOG_GFFNEWFIELDADDED => 'Added new field to GFF file %s1...',
    LS_LOG_GFFBLANKVALUE    =>
      'Blank value encountered for GFF field label %s1, skipping...',
    LS_LOG_GFFMODIFIEDVALUE  => 'Modified value "%s1" to field "%s2" in %s3.',
    LS_LOG_GFFINCORRECTLABEL =>
      'Unable to find a field label matching "%s1" in %s2, skipping...',
    LS_LOG_GFFBACKUPFILE => 'Saving unaltered backup copy of %s1 file in %s2',
    LS_LOG_GFFBACKUPDEST =>
      'Saving unaltered backup copy of destination file %s1 file in %s2',
    ...
    LS_LOG_GFFNOMODIFIERS     =>
      'No GFF modifier instructions found for file %s1, skipping...',
    ...
    LS_LOG_HAKMODIFYINGDATA =>
      'Modifying file %s1, setting value at offset "%s2" to "%s3".',
    LS_LOG_HAKINVALIDOFFSET =>
      'Invalid offset(%s1) or value(%s2) modifier for file %s3. Skipping...',
    ...
    LS_LOG_NCSDESTBACKUP       =>
      'Saving unaltered backup copy of destination file %s1 in %s2',
    LS_LOG_NCSFILEEXISTSKIP =>
    ...
    # SSF file handler
    LS_LOG_SSFNOMODIFIERS =>
      'File "%s1" has no modifier section specified! Skipping it...',
    ...
    LS_LOG_SSFINVALIDSTRREF =>
      'Unable to set StrRef for entry "%s1", %s2 is not a valid StrRef value!',
    ...
    LS_DLG_FILESELECTDESCMOD =>
      'Please select the %s1 file that came with this Mod.',
    LS_DLG_FILEWORD         => '%s1 File',
    LS_EXC_FHNODESTSELECTED =>
      'Error! No valid game folder selected! Installation aborted.',
    LS_EXC_FHREQFILEMISSING =>
      'Cannot locate required file %s1, unable to continue with install!',
    ...
    LS_LOG_FHDESTRESEXISTMOD =>
      'File "%s1" already exists in archive "%s2", modifying existing file...',
    LS_LOG_FHSOURCENOTFOUND =>
    ...
    LS_LOG_FHBACKUPSCRIPT =>
      'Making backup copy of script file "%s1" found in override...',
    LS_LOG_FHSCRIPTEXISTS =>
      'Script file "%s1" already exists in override! Skipping...',
    LS_LOG_FHUPDATEREPLACE =>
      'Updating and replacing file %s1 in Override folder...',
    LS_LOG_FHUPDATECOPY =>
      'Updating and copying file %s1 to Override folder...',
    LS_LOG_FHINSFILENOTFOUND =>
      'Unable to locate file "%s1" to install, skipping...',
    LS_LOG_FHCOPY2OVERRIDE     => 'Copying file %s1 to Override folder...',
    LS_LOG_FHSAVEASSRCNOTFOUND =>
      'Unable to locate file "%s1" to install as "%s2", skipping...',
    ...
    LS_EXC_FHCRITFILEMISSING =>
      'Critical error: Unable to locate file to patch, "%s1" file not found!',
    LS_LOG_FHMODIFYINGFILE =>
      'Modifying file "%s1" found in Override folder...',
...
sub ProcessMessage {
    ...
    else { $log_text .= "$pre\\cf$colorlog  \\bullet  $prefix$message\n"; }

    if ( $InstallInfo{bLogOld} == 0 ) {
        $GUI->{mwInstallText}
          ->insert( 'end', " • " . $prefix . $message . "\n", [$color] );
    }
    else {
...
sub ProcessNamespaces {
    ...
    foreach ( $ns_ini->section_values('Namespaces') ) {
        ...
        $nsOptions{ $nsOptions{Count} }{Desc} =
          $ns_ini->get( $_, 'Description' );

        $GUI->{nsBrowser}
          ->insert( 'end', $nsOptions{ $nsOptions{Count} }{Name} );
    }
...
sub RunInstallPath {
    $GUI->{bm}->withdraw;
    $GUI->{mw}
      ->Popup( -popover => undef, -overanchor => 'c', -popanchor => 'c' );
    ...
    if ( -e "$install_path/namespaces.ini" ) {
        ...
        if ( -e "$install_path/$install_info" ) {
            ...
            foreach ( $ini_object->section_params('Settings') ) {
                $uninstall_ini->set( 'Settings', $_,
                    $ini_object->get( 'Settings', $_, '' ) );
            }
            ...
            # print "h5\n";
            $InstallInfo{caption} =
              $ini_object->get( 'Settings', 'WindowCaption',
                $Messages{LS_GUI_DEFAULTCAPTION} );
            $InstallInfo{FileExists} =
              $ini_object->get( 'Settings', 'FileExists', 0 );
            $InstallInfo{bInstall} =
            ...
            $InstallInfo{bLogOld} =
              $ini_object->get( 'Settings', 'PlaintextLog', 0 );
            ...
            if ( $InstallInfo{FileExists} == 0 ) {
                ...
                # print "h7\n";
                $GUI->{Popup1}{Message} =
                  Format( $Messages{LS_GUI_CONFIGLOADERROR}, $install_ini );
            ...
            if ( $InstallInfo{bInstall} == 1 ) {
                ...
                # print "h9a\n";
                $GUI->{mwInstallBtn}
                  ->configure( -text => $Messages{LS_GUI_BUTTONCAPINSTALL} );
            }
            else {
                # print "h9b\n";
                $GUI->{mwInstallBtn}
                  ->configure( -text => $Messages{LS_GUI_BUTTONCAPPATCH} );
            }
...
sub Install {
    ...
    $InstallInfo{LookGame} =
      $ini_object->get( 'Settings', 'LookupGameFolder', 1 );
    $InstallInfo{LookNum} =
      $ini_object->get( 'Settings', 'LookupGameNumber', 1 );
    $InstallInfo{SaveNss} =
      $ini_object->get( 'Settings', 'SaveProcessedScripts', 0 );
    $InstallInfo{RequiredFile} = $ini_object->get( 'Settings', 'Required', '' );
    $InstallInfo{RequiredMsg} =
      $ini_object->get( 'Settings', 'RequiredMsg', '' );
    ...
    # }
        ...
        $install_dest_path = $GUI->{mw}->chooseDirectory(
            -title => 'Select the KotOR '
              . $InstallInfo{LookNum}
              . ' Main Directory...',
            -mustexist => 1,
            -parent    => $GUI->{mw}
        ...
        if ( ( -e $install_dest_path ) == 0 ) {
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_INSINVALIDDESTINATION},
                    $install_dest_path
                )
            );
            $GUI->{Popup1}{Message} =
              Format( $Messages{LS_LOG_INSINVALIDDESTINATION},
                $install_dest_path );
            $GUI->{Popup1}{Widget}->Show();
            exit;
        }
    ...
    ProcessMessage( "Install path set to $install_dest_path.",
        LOG_LEVEL_VERBOSE );
    ...
    if ( $time[2] > 12 ) {
        $timestring =
            ( $time[2] - 12 )
          . ":$time[1]:$time[0] PM on $time[4]/$time[3]/"
          . $time[5];
    }
    else {
        $timestring = "$time[2]:$time[1]:$time[0] AM on $time[4]/$time[3]/"
          . ( $time[5] + 1900 );
    }
    ...
    if ( $log_alerts > 0 and $log_errors == 0 ) {
        ProcessMessage( Format( $Messages{LS_LOG_RPOSUMMARYWARN}, $log_alerts ),
            LOG_LEVEL_NOTICE );
        $GUI->{Popup1}{Message} =
          Format( $Messages{LS_LOG_RPOSUMMARYWARN}, $log_alerts );
    }
    elsif ( $log_alerts == 0 and $log_errors > 0 ) {
        ProcessMessage(
            Format( $Messages{LS_LOG_RPOSUMMARYERROR}, $log_errors ),
            LOG_LEVEL_NOTICE );
        $GUI->{Popup1}{Message} =
          Format( $Messages{LS_LOG_RPOSUMMARYERROR}, $log_errors );
    }
        ...
        ProcessMessage(
            Format(
                $Messages{LS_LOG_RPOSUMMARYWARNERROR}, $log_alerts,
                $log_errors
            ),
            LOG_LEVEL_NOTICE
        );
        $GUI->{Popup1}{Message} = Format( $Messages{LS_LOG_RPOSUMMARYWARNERROR},
            $log_alerts, $log_errors );
    }
    else {
...
sub Uninstall {
    ...
    $InstallInfo{LookGame} =
      $ini_object->get( 'Settings', 'LookupGameFolder', 1 );
    $InstallInfo{LookNum} =
      $ini_object->get( 'Settings', 'LookupGameNumber', 2 );
    $InstallInfo{SaveNss} =
      $ini_object->get( 'Settings', 'SaveProcessedScripts', 0 );
    $InstallInfo{RequiredFile} = $ini_object->get( 'Settings', 'Required', '' );
    $InstallInfo{RequiredMsg} =
...
sub ExecuteFile {
    ...
    if ( ( defined($destination) == 0 ) or ( $destination eq '' ) ) {
    ...
    if ( $patchtype eq 'fileTLK' ) {
        ...
        if ( $ext eq 'are' ) {
            $FileBox{-filetypes} = [ [ 'Area template', '.are' ] ];
        }
        elsif ( $ext eq 'dlg' ) {
            $FileBox{-filetypes} = [ [ 'Conversation file', '.dlg' ] ];
        }
        elsif ( $ext eq 'fac' ) {
            $FileBox{-filetypes} = [ [ 'Faction template', '.fac' ] ];
        }
        elsif ( $ext eq 'gff' ) {
            $FileBox{-filetypes} = [ [ 'GFF template', '.gff' ] ];
        }
        elsif ( $ext eq 'git' ) {
            $FileBox{-filetypes} = [ [ 'Area Properties', '.git' ] ];
        }
        elsif ( $ext eq 'ifo' ) {
            $FileBox{-filetypes} = [ [ 'Level Properties', '.ifo' ] ];
        }
        elsif ( $ext eq 'utc' ) {
            $FileBox{-filetypes} = [ [ 'Creature template', '.utc' ] ];
        }
        elsif ( $ext eq 'utd' ) {
            $FileBox{-filetypes} = [ [ 'Door template', '.utd' ] ];
        }
        elsif ( $ext eq 'ute' ) {
            $FileBox{-filetypes} = [ [ 'Encounter template', '.ute' ] ];
        }
        elsif ( $ext eq 'uti' ) {
            $FileBox{-filetypes} = [ [ 'Item template', '.uti' ] ];
        }
        elsif ( $ext eq 'utm' ) {
            $FileBox{-filetypes} = [ [ 'Store template', '.utm' ] ];
        }
        elsif ( $ext eq 'utp' ) {
            $FileBox{-filetypes} = [ [ 'Placeable template', '.utp' ] ];
        }
        elsif ( $ext eq 'uts' ) {
            $FileBox{-filetypes} = [ [ 'Sound List template', '.utS' ] ];
        }
        elsif ( $ext eq 'utt' ) {
            $FileBox{-filetypes} = [ [ 'Trigger template', '.utt' ] ];
        }
        elsif ( $ext eq 'utw' ) {
            $FileBox{-filetypes} = [ [ 'Waypoint template', '.utw' ] ];
        }
    ...
    if ( $InstallInfo{bInstall} == 1 ) {
        ...
        if ( $patchtype eq 'fileTLK' ) {
            if ( -e "$install_dest_path/$filename" ) {
                ...
                $GUI->{Popup1}{Message} =
                  Format( $Messages{LS_EXC_FHTLKFILEMISSING}, $filename );
                $GUI->{Popup1}{Widget}->Show();
        ...
        if ( ( -e "$install_dest_path/override" ) == 0 ) {
            make_path(
                "$install_dest_path\\override",
                { chmod => 0777, user => $user }
            );
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_FHMAKEOVERRIDE},
                    "$install_dest_path/override"
                ),
        ...
        if ( $patchtype eq 'fileGFFERF' ) {
            ...
            if ( ( -e $dest ) == 0 ) {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_FHDESTNOTFOUND}, $destination,
                        $filename
                    ),
                    LOG_LEVEL_ERROR
                );
            ...
            my ( $ERF, $IsERF, $ERF_name, $ERF_type ) =
            ...
            if ( $destination ~~ @ERFs ) {
                ...
                if ( ( MakeBackup( "$dest", 'modules' ) ) == 1 ) {
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_INSBACKUPFILE}, $ERF_name,
                            $install_path . "\\backup\\"
                        ),
                        LOG_LEVEL_INFORMATION
                    );
                ...
                make_path(
                    "$install_path/" . $ERF_name,
                    { chmod => 0777, user => $user }
                );

                foreach ( @{ $ERF->{Files} } ) {
                    $ERF->export_resource_by_index(
                        $ERF->get_resource_id_by_name($_),
                        "$install_path/$ERF_name/$_"
                    );
                }
            }
            ...
            if (    ( $overwrite == 0 )
                and ( -e "$install_path/$ERF_name/$saveas" ) )
            {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_FHDESTRESEXISTMOD}, $saveas,
                        $destination
                    ),
                    LOG_LEVEL_INFORMATION
                );
                ...
                my $sourcefile =
                  $ini_object->get( $filename, '!SourceFile', $filename );

                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_FHADDTODEST}, $saveas,
                        ( split( /(\\|\/)/, $destination ) )[-1]
                    ),
                    LOG_LEVEL_INFORMATION
                );
                if (
                    (
                        File::Copy::copy(
                            "$install_path\\$sourcefile",
                            "$install_path\\$ERF_name\\$saveas"
                        )
                    ) == 0
                  )
                {
                    ...
                    if ( $GUI->{Popup2}{Widget}->Show() ne 'Yes' ) {
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_FHTEMPFILEFAILED}, $saveas
                            ),
                            LOG_LEVEL_ERROR
                        );
                        return ( -1, '' );
        ...
        if ( $patchtype eq 'fileCompile' ) {
            ...
            if ( ( -e "$install_path/$saveas" ) == 0 ) {
                ProcessMessage(
                    Format( $Messages{LS_LOG_FHSOURCENOTFOUND}, $saveas ),
                    LOG_LEVEL_ERROR );
            ...
            if ( $overwrite == 1 ) {
                if (    ( lc($destination) eq 'override' )
                    and ( -e "$install_dest_path\\override\\$temp" ) )
                {
                    if ( $InstallInfo{Backups} == 1 ) {
                        if ( ( -e "$install_path/backup/override/$temp" ) == 0 )
                        {
                            MakeBackup( "$install_path/override/$temp",
                                'override' );
                            ProcessMessage(
                                Format(
                                    $Messages{LS_LOG_FHBACKUPSCRIPT}, $filename
                                ),
                                LOG_LEVEL_INFORMATION
                            );
                        }
        ...
        if ($overwrite) {
            my $sourcefile =
              $ini_object->get( $filename, '|SourceFile', $filename );
            my $saveasfile =
              $ini_object->get( $filename, '|SaveAs', $filename );

            if ( -e "$install_path/$sourcefile" ) {
                if ( -e "$install_dest_path/$destination/$saveasfile" ) {
                    if ( $InstallInfo{Backups} == 1 ) {
                        MakeBackup(
                            "$install_dest_path/$destination/$saveasfile",
                            $destination );
                    }
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_FHUPDATEREPLACE}, $saveasfile
                        ),
                        LOG_LEVEL_INFORMATION
                    );
                }
                    ...
                    ProcessMessage(
                        Format( $Messages{LS_LOG_FHUPDATECOPY}, $saveasfile ),
                        LOG_LEVEL_INFORMATION );
                }

                File::Copy::copy( "$install_path\\$sourcefile",
                    "$install_dest_path\\$destination\\$saveasfile" );
                return ( 1, "$install_dest_path/$destination/$saveasfile" );
            }
            else {
                ProcessMessage(
                    Format( $Messages{LS_LOG_FHINSFILENOTFOUND}, $filename ),
                    LOG_LEVEL_ERROR );
                return ( -1, '' );
            }
        }
        ...
        if ( $patchtype eq 'fileHACK' ) {
            ...
            if ( ( -e "$install_dest_path/$destination/$saveasfile" ) == 0 ) {
                if ( -e "$install_path/$sourcefile" ) {
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_FHCOPY2OVERRIDE}, $saveasfile
                        ),
                        LOG_LEVEL_INFORMATION
                    );
                    return ( 1, "$install_dest_path/$destination/$saveasfile" );
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_FHSAVASSRCNOTFOUND}, $filename,
                            $sourcefile
                        ),
                        LOG_LEVEL_ERROR
                    );
                ...
                ProcessMessage(
                    Format( $Messages{LS_LOG_FHFILEEXISTSKIP}, $saveasfile ),
                    LOG_LEVEL_ALERT );
                return ( -1, '' );
            }
        }
        ...
        if ( ( -e "$install_dest_path\\$destination\\$saveasfile" ) == 0 ) {
            if ( ( -e "$install_path\\$sourcefile" ) == 0 ) {
                ProcessMessage( $Messages{LS_LOG_FHNOTSLPATCHDATAFILE},
                    LOG_LEVEL_VERBOSE );
                $FileBox{-title} = Format( $Messages{LS_DLG_MANUALLOCATEFILE},
                    $saveasfile, $sourcefile );
                my $located = $GUI->{mw}->getOpenFile(%FileBox);

                if ( $located ne '' ) {
                    File::Copy::copy( $located,
                        "$install_dest_path\\$destination\\$saveasfile" );
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_FHCOPYFILEAS}, $sourcefile,
                            $saveasfile
                        ),
                        LOG_LEVEL_INFORMATION
                    );
                    ...
                    $GUI->{Popup1}{Message} =
                      Format( $Messages{LS_EXC_FHCRITFILEMISSING},
                        $saveasfile );
                    $GUI->{Popup1}{Widget}->Show();
            ...
            ProcessMessage(
                Format( $Messages{LS_LOG_FHMODIFYINGFILE}, $saveasfile ),
                LOG_LEVEL_INFORMATION );
...
sub MakeBackup {
    ...
    if ( ( -e "$backup_path\\backup" ) == 0 ) {
        make_path( "$backup_path\\backup", { chmod => 0777, user => $user } );
    }
    if ( ( -e "$backup_path\\backup\\$folder" ) == 0 ) {
        make_path( "$backup_path\\backup\\$folder",
            { chmod => 0777, user => $user } );
    }
...
sub HandleERFOverrideType {
    ...
    if ( $bNoDest == 0 ) {
        $destination =
          lc( $ini_object->get( $section, '!Destination', $AltDest ) );

        if ( $destination eq 'override' ) { return; }
    }
    ...
    if ( ( -e $file ) == 0 ) {
        ProcessMessage( Format( $Messages{LS_LOG_OVRCHECKNOFILE}, $filename ),
            LOG_LEVEL_VERBOSE );
        return;
    }
    ...
    if ( $type eq 'warn' ) {
        ProcessMessage(
            Format( $Messages{LS_LOG_OVRCHECKEXISTWARN}, $filename ),
            LOG_LEVEL_ALERT );
    }
        ...
        if ( File::Copy::copy( $file, $new ) ) {
            ...
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_OVRCHECKRENAMED}, $filename,
                    "old_$filename"
                ),
                LOG_LEVEL_INFORMATION
            );
            ...
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_OVRRENAMEFAILED}, $filename,
                    "old_$filename"
                ),
                LOG_LEVEL_ALERT
            );
...
sub DoTLKList {
    ...
    foreach $key (@lines) {
        ...
        if ( lc( substr( $key, 0, 6 ) ) eq 'strref' ) {
            ...
            $tlk_data{ "Delete" . substr( $key, 6, ( length($key) - 6 ) ) } =
              $value;
            $delete_count++;
        }
        elsif ( lc( substr( $key, 0, 6 ) ) eq 'change' ) {
            $tlk_data{ "Change" . substr( $key, 6, ( length($key) - 6 ) ) } =
              $value;
            $change_count++;
        }
    }
    ...
    if ( $entry_count > 0 ) {
        ProcessMessage(
            Format( $Messages{LS_LOG_LOADEDSTRREFTOKENS}, $entry_count ),
            LOG_LEVEL_VERBOSE );
    }
    ...
    foreach my $action ( TLK_TYPE_NORMAL, TLK_TYPE_FEMALE ) {
        ...
        if ( $answer[0] == 1 ) {
            if (    ( ( -e "$install_path/$default" ) == 1 )
                and ( ( -e $answer[1] ) == 1 ) )
            {
                $dialog = ( split( /\//, $answer[1] ) )[-1];
                ProcessMessage(
                    Format( $Messages{LS_LOG_APPENDFEEDBACK}, $answer[1] ),
                    LOG_LEVEL_INFORMATION );

                $tlk_dialog->load_tlk( $answer[1] );
                $tlk_append->load_tlk( "$install_path\\"
                      . $ini_object->get( 'TLKList', '!SourceFile', $default )
                );

                # Change entries in the dialog.tlk file
                if ( $change_count > 0 ) {
                    ProcessMessage( $Messages{LS_TLK_CHANGING},
                        LOG_LEVEL_INFORMATION );
                    ...
                    foreach ( 0 .. ( $change_count - 1 ) ) {
                        ...
                        if ( ( $ini_object->get( $section, '!Entry', '-1' ) ) <
                            0 )
                        {
                            ProcessMessage(
                                Format( $Messages{LS_TLK_CHANGENOIDEA}, $_ ),
                                LOG_LEVEL_ERROR );
                            next;
                        }

                        ProcessMessage(
                            Format( $Messages{LS_TLK_CHANGENUM}, $_ ),
                            LOG_LEVEL_VERBOSE );
                        ...
                        foreach ( $ini_object->section_params($section) ) {
                            $uninstall_ini->set( $section, $_,
                                $ini_object->get( $section, $_, '' ) );

                            if ( $dialog eq 'dialogf.tlk' ) {
                                if ( lc($_) eq 'textf' ) {
                                    $tlk_dialog->edit_entry(
                                        $entry, 'Text',
                                        $ini_object->get(
                                            $section, $_,
                                            $ini_object->get(
                                ...
                                if ( lc($_) eq 'text' ) {
                                    $tlk_dialog->edit_entry( $entry, 'Text',
                                        $ini_object->get( $section, $_, '' ) );
                                }
                            }

                            if ( lc($_) eq 'flags' ) {
                                $tlk_dialog->edit_entry( $entry, 'Flags',
                                    $ini_object->get( $section, $_ ) );
                            }
                            if ( lc($_) eq 'sound' ) {
                                $tlk_dialog->edit_entry( $entry, 'Sound',
                                    $ini_object->get( $section, $_ ) );
                            }
                        }
                    }
                    ...
                    ProcessMessage(
                        Format( $Messages{LS_TLK_CHANGETOTAL}, $change_count ),
                        LOG_LEVEL_VERBOSE
                    );
                }
                ...
                if ( $delete_count > 0 ) {
                    ProcessMessage( $Messages{LS_TLK_DELETING},
                        LOG_LEVEL_INFORMATION );

                    foreach ( 0 .. ( $delete_count - 1 ) ) {
                        ProcessMessage(
                            Format( $Messages{LS_TLK_DELETNUM}, $_ ),
                            LOG_LEVEL_VERBOSE );
                        $tlk_dialog->delete_entry( $tlk_data{"Delete$_"} );
                    }

                    ProcessMessage(
                        Format( $Messages{LS_TLK_DELETETOTAL}, $delete_count ),
                        LOG_LEVEL_VERBOSE
                    );
                }
                ...
                if ( $entry_count > 0 ) {
                    my $entry = undef;
                    foreach $entry (
                        0 .. ( $tlk_append->{'string_count'} - 1 ) )
                    {
                        my ( $text, $sound, $flags, $length ) =
                          ( undef, undef, undef, undef );
                        ...
                        my ( $return, $new ) =
                          $tlk_dialog->add_entry( $text, $sound, $flags,
                            $length );
                        ...
                        if ( $return == -1 ) {
                            ...
                            ProcessMessage(
                                Format(
                                    $Messages{LS_LOG_TLKENTRYMATCHEXIST},
                                    $entry, $dialog, $new
                                ),
                                LOG_LEVEL_VERBOSE
                            );
                            ...
                            ProcessMessage(
                                Format(
                                    $Messages{LS_LOG_APPENDTLKENTRY}, $dialog,
                                    $new
                                ),
                                LOG_LEVEL_VERBOSE
                            );
                ...
                if ( $count > 0 ) {
                    if ( MakeBackup( $answer[1], '' ) == 1 ) {
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_MAKETLKBACKUP}, $dialog,
                                "$install_path\\backup"
                            ),
                            LOG_LEVEL_INFORMATION
                        );
                    ...
                    if ( ( $added > 0 ) and ( $reused > 0 ) ) {
                        ...
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_TLKSUMMARY2}, $dialog,
                                $added
                            ),
                            LOG_LEVEL_INFORMATION
                        );
                        ...
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_TLKSUMMARY3}, $dialog,
                                $reused
                            ),
                            LOG_LEVEL_INFORMATION
                        );
                        ...
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_TLKSUMMARYWARNING}, $dialog
                            ),
                            LOG_LEVEL_ALERT
                        );
                    }
                ...
                ProcessMessage(
                    Format( $Messages{LS_LOG_TLKFILEMISSING}, $dialog ),
                    LOG_LEVEL_ERROR );
            }
        }
        else {
            ProcessMessage( Format( $Messages{LS_LOG_TLKNOTSELECTED}, $dialog ),
                LOG_LEVEL_ERROR );
        }
    }
...
sub ProcessStrRefToken {
    ...
    if ( $token ne '' ) {
        if ( lc( substr( $token, 0, 6 ) ) eq 'strref' ) {
            ...
            if ( $index >= 0
                and ( defined( $Tokens{ 'StrRef' . $index } ) == 1 ) )
            {
    ...
    ProcessMessage( Format( $Messages{LS_LOG_UNKNOWNSTRREFTOKEN}, $token ),
        LOG_LEVEL_ERROR );
    return 0;
}
    ...
    foreach my $section (@lines1) {
        ...
        if ( -f "$install_dest_path\\$folder" ) {
            if ( -e "$install_dest_path\\$folder" ) {
                if ( IsValidArchive("$install_dest_path\\$folder") == 1 ) {
                    $IsArchive = 1;
                }
                else {
                    ProcessMessage(
                        Format( $Messages{LS_LOG_INSDESTINVALID}, $folder ),
                        LOG_LEVEL_ERROR );
                    next;
                }
            }
                ...
                ProcessMessage(
                    Format( $Messages{LS_LOG_INSDESTNOTEXIST}, $folder ),
                    LOG_LEVEL_ERROR );
                next;
            }
        }
        ...
        if ( $folder ne '' and ( $folder =~ /\.\.\\/ ) == 0 ) {
            ...
            if ( $IsArchive == 0 and ( -e "$install_dest_path\\$folder" ) == 0 )
            {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_INSCREATEFOLDER},
                        "$install_dest_path\\$folder"
                    ),
                    LOG_LEVEL_INFORMATION
                );
                ...
                if (@$err) {
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_INSFOLDERCREATEFAIL},
                            "$install_dest_path\\$folder"
                        ),
                        LOG_LEVEL_ERROR
                    );
            ...
            if ( ( scalar @lines2 ) > 0 ) {
                if ( $IsArchive == 1 ) {
                    ...
                    if (
                        (
                            MakeBackup(
                                "$install_dest_path\\$folder", 'modules'
                            )
                        ) == 1
                      )
                    {
                    ...
                    $ERF_name =
                      substr( $ERF_name, 0, ( length($ERF_name) - 4 ) );
                ...
                foreach (@lines2) {
                    ...
                    {
                        if ( $IsArchive ==
                            0 )    # Copying (or replacing) to a folder
                        {
                            if ( -e "$install_dest_path\\$folder\\$file"
                              )    # The file exists already...
                            {
                                if (
                                    lc( substr( $key, 0, 7 ) ) eq 'replace'
                                  )    # The file exists, but will be replaced
                                {
                                    if (
                                        index( $key, '.exe' ) >
                                        0 )    # Make sure it's not an .exe.
                                    {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSNOEXEPLEASE}
                                                ,
                                                $file
                                            ),
                                            LOG_LEVEL_ALERT
                                    ...
                                    if (
                                        index( $key, '.tlk' ) >
                                        0 )    # Make sure it's not a .tlk.
                                    {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSENOUGHTLK},
                                                $file
                                            ),
                                            LOG_LEVEL_ALERT
                                        );
                                    ...
                                    if (
                                        index( $key, '.key' ) >
                                        0 )    # Make sure it's not a .key.
                                    {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSSKELETONKEY}
                                                ,
                                                $file
                                            ),
                                            LOG_LEVEL_ALERT
                                    ...
                                    if (
                                        index( $key, '.bif' ) >
                                        0 )    # Make sure it's not a .bif.
                                    {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSBIFTHEUNDERSTUDY}
                                                ,
                                                $file
                                            ),
                                            LOG_LEVEL_ALERT
                                    ...
                                    $uninstall_ini->set( $section,
                                        "Replace$repnum", $filename );

                                    if (
                                        $uninstall_ini->section_exists(
                                            $filename) == 0
                                      )
                                    {
                                    ...
                                    $uninstall_ini->set( $filename,
                                        '!SourceFile', $filename );
                                    $uninstall_ini->set( $filename, '!SaveAs',
                                        $filename );
                                    $repnum++;
                                    ...
                                    if ( $file ne $sourcefile ) {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSREPLACERENAME}
                                                ,
                                                $sourcefile,
                                                $file,
                                                $foldername
                                ...
                                {
                                    if ( $ini_object->get( $file, '!Silent', 0 )
                                        == 0 )
                                    {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSLASKIP},
                                                $file, $foldername
                                            ),
                                            LOG_LEVEL_ALERT
                                        );
                                ...
                                # The file doesn't exist, just copy it over.
                                $uninstall_ini->set( $section, "Delete$delnum",
                                    $filename );

                                if ( $uninstall_ini->section_exists($filename)
                                    == 0 )
                                {
                                    $uninstall_ini->add_section($filename);
                                }

                                $uninstall_ini->set( $filename, '!SourceFile',
                                    $filename );
                                $uninstall_ini->set( $filename, '!SaveAs',
                                    $filename );
                                $delnum++;
                                ...
                                if ( $file ne $sourcefile ) {
                                    ProcessMessage(
                                        Format(
                                            $Messages{LS_LOG_INSRENAMECOPY},
                                            $sourcefile, $file, $foldername
                                        ),
                                        LOG_LEVEL_INFORMATION
                                    );
                                }
                            ...
                            # Inserting the file into an ERF or RIM
                            if ( ( -e "$install_path\\$ERF_name\\$file" ) ==
                                1 )    # It already exists in the ERF or RIM.
                            {
                                if (
                                    lc( substr( $key, 0, 7 ) ) eq
                                    'replace' )   # It will be replaced, though.
                                {
                                    $uninstall_ini->set( $section,
                                        "Replace$repnum", $filename );
                                    ...
                                    if ( $file ne $sourcefile ) {
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSREPLACERENAMEFILE}
                                                ,
                                                $sourcefile,
                                                $file,
                                                $foldername
                                        ...
                                        ProcessMessage(
                                            Format(
                                                $Messages{LS_LOG_INSREPLACEFILE}
                                                ,
                                                $file,
                                                $foldername
                                            ),
                                ...
                                if ( $file ne $sourcefile ) {
                                    ProcessMessage(
                                        Format(
                                            $Messages{LS_LOG_INSRENAMEADDFILE},
                                            $sourcefile, $file, $foldername
                                        ),
                                        LOG_LEVEL_INFORMATION
                                    );
                        ...
                        ProcessMessage(
                            Format( $Messages{LS_LOG_INSCOPYFAILED}, $file ),
                            LOG_LEVEL_ERROR );
                    }
                }
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_INSNOMODIFIERS}, $section,
                        $foldername
                    ),
                    LOG_LEVEL_ERROR
                );
            ...
            ProcessMessage(
                Format( $Messages{LS_LOG_INSINVALIDDESTINATION}, $foldername ),
                LOG_LEVEL_ERROR
            );
        }
    }
    ...
    foreach $filename (@lines1) {
        ...
        if ( $filename ne '' and $answer[0] == 1 ) {
            ...
            if ( ( -e $file ) == 0 ) {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DAFILENOTFOUND},
                        ( split( /\//, $file ) )[-1]
                    ),
                    LOG_LEVEL_ERROR
                );
            ...
            if ( $two_da->read2da($file) > 0 ) {
                ...
                foreach $row_job (@lines2) {
                    ...
                    if ( $row_job =~ /AddRow/ ) {
                        ...
                        Change2daRow( $two_da, $modifier );
                    }
                    elsif ( $row_job =~ /AddColumn/ ) {
                        Add2daColumn( $two_da, $modifier );
                    }
                    elsif ( $row_job =~ /DeleteColumn/ ) {
                        Delete2daColumn( $two_da, $modifier );
                    }
                    elsif ( $row_job =~ /CopyRow/ ) {
                        Copy2daRow( $two_da, $modifier );
                    }
                    else {
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_2DAINVALIDMODIFIER},
                                $row_job, $modifier
                            ),
                            LOG_LEVEL_ALERT
                        );
            ...
            ProcessMessage(
                Format( $Messages{LS_LOG_2DANOFILESELECTED}, $filename ),
                LOG_LEVEL_ALERT );
        }
...
sub GetMemoryToken {
    ...
    if ( substr( $value, 0, 9 ) eq '2DAMEMORY' ) {
        ...
        if ( $tmp >= 0 ) {
            if (    ( ( $tmp ~~ @twoda_tokens ) == 0 )
                and ( ( scalar @twoda_tokens ) > 0 )
              ) # (((scalar @twoda_tokens) - 1) < $tmp) and (((scalar @twoda_tokens) - 1) > 0))
            {
                $tmp = 1;
                ProcessMessage(
                    Format( $Messages{LS_LOG_TOKENINDEXERROR1}, $value ),
                    LOG_LEVEL_ALERT );
            }
            elsif ( ( ( $tmp ~~ @twoda_tokens ) == 0 )
                and ( ( scalar @twoda_tokens ) < 1 )
              ) # if((((scalar @twoda_tokens) - 1) < $tmp) and (((scalar @twoda_tokens) - 1) <= 0))
            {
                ProcessMessage(
                    Format( $Messages{LS_LOG_TOKENINDEXERROR2}, $value ),
                    LOG_LEVEL_ERROR );
                return $value;
            }
        ...
        ProcessMessage(
            Format(
                $Messages{LS_LOG_GETTOKENVALUE}, $value,
                $Tokens{ '2DAMEMORY' . $tmp }
            ),
            LOG_LEVEL_VERBOSE
        );
...
sub SetMemoryToken {
    ...
    if ( substr( $key, 0, 9 ) eq '2DAMEMORY' ) {
        ...
        if (   $action == ACTION_ADD_ROW
            or $action == ACTION_COPY_ROW
            or $action == ACTION_MODIFY_ROW )
        {
            if ( $value eq 'RowIndex' ) {
                push( @twoda_tokens, $tmp );
                $Tokens{ '2DAMEMORY' . $tmp } = $rowindex;
                ProcessMessage(
                    Format( $Messages{LS_LOG_TOKENFOUND}, $key, $rowindex ),
                    LOG_LEVEL_VERBOSE );
            }
                ...
                if ( ( $rowindex > -1 ) and ( $rowindex < $twoda->{rows} ) ) {
                    push( @twoda_tokens, $tmp );
                    $Tokens{ '2DAMEMORY' . $tmp } =
                      $twoda->get_row_header($rowindex);
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_TOKENFOUND}, $key,
                            $twoda->get_row_header($rowindex)
                        ),
                        LOG_LEVEL_VERBOSE
                    );
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_TOKENCOLLABELERROR}, $rowindex
                        ),
                        LOG_LEVEL_ALERT
                    );
                }
                ...
                push( @twoda_tokens, $tmp );
                $Tokens{ '2DAMEMORY' . $tmp } =
                  $twoda->get_cell( $twoda->get_row_header($rowindex), $value );
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_TOKENFOUND}, $key,
                        $Tokens{ '2DAMEMORY' . $tmp }
            ...
            if ( $value eq 'ColumnLabel' ) {
                if (    $rowindex > -1
                    and $rowindex < ( scalar @{ $twoda->{columns} } ) )
                {
                    push( @twoda_tokens, $tmp );
                    $Tokens{ '2DAMEMORY' . $tmp } =
                      @{ $twoda->{columns} }[$rowindex];
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_TOKENFOUND}, $key,
                            $Tokens{ '2DAMEMORY' . $tmp }
                ...
                elsif ( ( lc( substr( $value, 0, 1 ) ) eq 'l' )
                    and ( $tmp ne '' ) )
                {
            ...
            if ( lc($value) eq 'listindex' ) {
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_LINDEXTOKENFOUND},
                        $key, $rowindex
                    ),
                    LOG_LEVEL_VERBOSE
                );
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_FPATHTOKENFOUND}, $key, $constant
                    ),
                    LOG_LEVEL_VERBOSE
                );
            }
...
sub CheckForNonExclusiveLabel {
    ...
    if ( $haslabel == 0 ) {
        ProcessMessage(
            Format( $Messages{LS_LOG_EXCLUSIVECOLINVALID}, $exclusive ),
            LOG_LEVEL_ALERT );
        return ( 1, 0 );
    }
    ...
    if ( $value ne '' ) {
        foreach ( 0 .. ( $twoda->{rows} - 1 ) ) {
            if ( $twoda->get_cell( $twoda->get_row_header($_), $exclusive ) eq
                $value )
            {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_EXCLUSIVEMATCHFOUND}, $exclusive,
                        $_
                    ),
                    LOG_LEVEL_VERBOSE
                );
        ...
        ProcessMessage(
            Format(
                $Messages{LS_LOG_NOEXCLUSIVEVALUESET},
                $exclusive, $section
            ),
            LOG_LEVEL_ERROR
        );
...
sub CheckLabelIdentifier {
    ...
    if ( ( $key eq 'LabelIndex' ) and ( $value ne '' ) and ( $index == -1 ) ) {
        ...
        if ( $HasLabel == 0 ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_2DANOLABELCOL}, $key, $section ),
                LOG_LEVEL_ERROR );
            return $index;
        }

        foreach ( 0 .. ( $twoda->{rows} - 1 ) ) {
            if ( $twoda->get_cell( $twoda->get_row_header($_), 'label' ) eq
                $value )
            {
                if ( $index > -1 ) {
                    ProcessMessage( $Messages{LS_LOG_2DANONEXCLUSIVECOL},
                        LOG_LEVEL_ALERT );
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_2DAMULTIMATCHINDEX}, $index,
                            $_
                        ),
                        LOG_LEVEL_VERBOSE
                    );
    ...
    foreach $piece (@data) {
        ...
        if    ( $piece eq 'ExclusiveColumn' ) { next; }
            ...
            if ( lc($piece_value) eq 'high()' ) {
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DAHIGHTOKENRLFOUND}, $piece_value
                    ),
                    LOG_LEVEL_VERBOSE
                );
            }
            ...
            if ( $piece_value ne '' ) {
                if ( $added == 0 ) {
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_2DAADDINGROW}, $modify_row,
                            $twoda->{filename}
                        ),
                        LOG_LEVEL_VERBOSE
                    );
            ...
            $added == 1
            and SetMemoryToken(
                $piece, $piece_value, ACTION_ADD_ROW, $twoda, $modify_row
            )
          )
        {
        }    # do nothing
            ...
            if ( lc($piece_value) eq 'high()' ) {
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DAHIGHTOKENVALUE}, $piece,
                        $piece_value
                    ),
                    LOG_LEVEL_VERBOSE
                );
...
sub Delete2daRow {
    ...
    if ( $row == -1 ) {
        ProcessMessage( Format( $Messages{LS_LOG_2DADELETEROWERR}, $section ),
            LOG_LEVEL_ALERT );
        return -1;
    }
    ...
    foreach $piece (@data) {
            ...
            and ( $piece_value ne '' ) )
        {
            ...
            if ( ( $piece_value < 0 ) or ( $piece_value >= $twoda->{rows} ) ) {
                ...
                $uninstall_ini->set( $twoda->{filename},
                    "ChangeRow$twoda_chanum", $section );
                $uninstall_ini->add_section($section);
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DAMODIFYLINE}, $index,
                        $twoda->{'filename'}
                    ),
                    LOG_LEVEL_VERBOSE
                );
            ...
            and ( $piece_value ne '' ) )
        {
            ...
            $index = CheckLabelIdentifier( $index, $twoda, $section, $piece,
                $piece_value );
            ...
            and ( lc($piece) ne 'rowlabel' )
            and ( lc($piece) ne 'rowindex' ) )
        {
            ProcessMessage(
                Format( $Messages{LS_LOG_2DANOINDEXFOUND}, $section ),
                LOG_LEVEL_ERROR );
            return;
        }
        elsif (
            ( $index > -1 )
            and SetMemoryToken(
                $piece, $piece_value, ACTION_MODIFY_ROW, $twoda, $index
            )
          )
        {
            # Do nothing here
            ...
            if ( $piece ~~ @{ $twoda->{columns} } ) {
                ...
                $uninstall_ini->set( $piece,
                    $twoda->get_cell( $twoda->get_row_header($index), $piece )
                );
                $twoda->change_cell( $twoda->get_row_header($index),
                    $piece, $piece_value );
            }
        }
    }
...
sub Add2daColumn {
    ...
    ProcessMessage(
        Format( $Messages{LS_LOG_2DAADDCOLUMN}, $twoda->{filename} ),
        LOG_LEVEL_VERBOSE );
    ...
    foreach $piece (@lines) {
        ...
        if ( ( lc($piece) eq 'columnlabel' ) and ( $added == 0 ) ) {
            if ( $piece_value ~~ @{ $twoda->{columns} } ) {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DACOLEXISTS}, $piece_value,
                        $twoda->{filename}
                    ),
                    LOG_LEVEL_ERROR
                );
            ...
            $uninstall_ini->set( $twoda->{filename},
                "DeleteColumn$twoda_colnum", $column );
            $twoda_colnum++;
            ...
            and (
                SetMemoryToken(
                    $piece, $piece_value, ACTION_ADD_COLUMN,
                    $twoda, $column
                )
            )
          )
        {
            ...
            if ( $piece_value ne '' ) {
                ...
                foreach $row ( 0 .. ( $twoda->{rows} - 1 ) ) {
                    if (
                        $twoda->get_cell( $twoda->get_row_header($row),
                            $column ) eq $old_default
                      )
                    {
                        $twoda->change_cell( $twoda->get_row_header($row),
                            $column, $default );
                    }
                }
            }
            ...
            if (    ( lc( substr( $piece, 0, 1 ) ) eq 'i' )
                and ( $index >= 0 )
                and ( $index < $twoda->{rows} ) )
            {
                $twoda->change_cell( $twoda->get_row_header($index),
                    $column, $piece_value );
            }
            elsif ( ( lc( substr( $piece, 0, 1 ) ) eq 'l' )
                and ( $index ne '' ) )
            {
...
sub Delete2daColumn {
    ...
    if ( $section ~~ @{ $twoda->{columns} } ) {
        ...
        ProcessMessage(
            Format(
                $Messages{LS_LOG_2DDELETINGCOLUMN}, $section,
                $twoda->{filename}
            ),
            LOG_LEVEL_VERBOSE
        );
        ...
        ProcessMessage( Format( $Messages{LS_LOG_2DADELETECOLERR}, $section ),
            LOG_LEVEL_ALERT );
        return 0;
    }
}
...
sub Copy2daRow {
    ...
    foreach $piece (@data) {
            ...
            and ( $piece_value ne '' ) )
        {
            ...
            and (
                SetMemoryToken(
                    $piece, $piece_value, ACTION_COPY_ROW, $twoda, $index
                )
            )
          )
        {
            ...
            if ( lc($piece_value) eq 'high()' ) {
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DANEWROWLABELHIGH}, $piece_value
                    ),
                    LOG_LEVEL_VERBOSE
                );
            }
            ...
            if ( $added == 0 ) {
                ...
                $index =
                  $twoda->add_row( $rowlabel, $twoda->get_row_header($index) );

                if ( $index == -1 ) {
                    ProcessMessage( $Messages{LS_LOG_2DACOPYFAILED},
                        LOG_LEVEL_ERROR );
                    return;
                }
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_2DACOPYINGLINE}, $old_index,
                        $index,                           $twoda->{filename}
                    ),
                    LOG_LEVEL_VERBOSE
                );
            }
            ...
            if (
                ( lc( substr( $piece_value, 0, 4 ) ) eq 'inc(' )
                and (
                    substr( $piece_value, ( length($piece_value) - 1 ), 1 ) eq
                    ')' )
              )
            {
                my $temp =
                  substr( $piece_value, 4, ( length($piece_value) - 1 ) );
                my $value =
                  $twoda->get_cell( $twoda->get_row_header($index), $piece );
                ...
                if ( ( $value >= 0 ) and ( $temp >= 0 ) ) {
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_2DAINCTOPENCOPY},
                            $piece, $temp, $piece_value
                        ),
                        LOG_LEVEL_VERBOSE
                    );
                }
                    ...
                    ProcessMessage(
                        Format( $Messages{LS_LOG_2DAINCFAILED}, $temp ),
                        LOG_LEVEL_ALERT );
                }
                elsif ( ( $value >= 0 ) and ( $temp < 0 ) ) {
                    ProcessMessage( $Messages{LS_LOG_2DAINCFAILEDNONUM},
                        LOG_LEVEL_ALERT );
                }
            }
...
sub DoGFFList {
    ...
    foreach $piece (@lines1) {
        ...
        if ( ( scalar @lines2 ) == 0 ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_GFFNOINSTRUCTION}, $piece_value ),
                LOG_LEVEL_ALERT );
            next;
        }
        else {
            $filename =
              $ini_object->get( $piece_value, '!Filename', $piece_value );
        }

        $Destination =
          $ini_object->get( $piece_value, '!Destination', 'override' );
        ...
        $Overwrite = 0;
        if ( $filename ne '' ) {
            $Overwrite = $ini_object->get( $piece_value, '!ReplaceFile', 0 );
        }

        @answer =
          ExecuteFile( $filename, $PatchType, $Overwrite, $Destination );
        ...
        if ( ( $filename ne '' ) and ( $answer[0] == 1 ) ) {
            ...
            if ( $result == 1 ) {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_GFFMODIFYINGFILE},
                        ( split( /\//, $answer[1] ) )[-1]
                    ),
                    LOG_LEVEL_INFORMATION
                );
                if ( $Overwrite == 0 ) {
                    $uninstall_ini->set( 'GFFList', "Replace$gff_repnum",
                        ( split( /\//, $answer[1] ) )[-1] );
                    $gff_repnum++;
                }
                else {
                    $uninstall_ini->set( 'GFFList', "Delete$gff_delnum",
                        ( split( /\//, $answer[1] ) )[-1] );
                    $gff_delnum++;
                }
                ...
                if ( ( scalar @lines2 ) > 0 ) {
                    ...
                    foreach $key (@lines2) {
                        ...
                        if ( $key eq '' ) {
                            $skip = 1;
                            ProcessMessage(
                                $Messages{LS_LOG_GFFBLANKFIELDLABEL},
                                LOG_LEVEL_ALERT );
                        }
                        ...
                        else { $value = GetMemoryToken($value); }

                        if (
                               ( lc( substr( $key, 0, 12 ) ) eq '!replacefile' )
                            or ( lc( substr( $key, 0, 12 ) ) eq '!destination' )
                            or ( lc( substr( $key, 0, 9 ) ) eq '!sourcefile' )
                            or ( lc( substr( $key, 0, 7 ) ) eq '!saveas' )
                            or
                        ...
                        if ( substr( $key, 0, 11 ) eq 'DeleteField' ) {
                            if ( DeleteGFFField( $gff, $value, '' ) == 1 ) {
                                ProcessMessage(
                                    Format(
                                        $Messages{LS_LOG_GFFFIELDDELETED},
                                        ( split( /\//, $answer[1] ) )[-1]
                                    ),
                                    LOG_LEVEL_INFORMATION
                                );
                        ...
                        if ( substr( $key, 0, 8 ) eq 'AddField' ) {
                            ...
                            if ( $v[0] == 1 ) {
                                $uninstall_ini->set( $un_section,
                                    "DeleteField$gff_delfnum",
                                    "delete_gff$gff_delfnum" . "_section" );

                                $uninstall_ini->add_section(
                                    "delete_gff$gff_delfnum" . "_section" );
                                $uninstall_ini->set(
                                    "delete_gff$gff_delfnum" . "_section",
                                    'Path',
                                    $ini_object->get( $value, 'Path', '' )
                                );
                                $uninstall_ini->set(
                                    "delete_gff$gff_delfnum" . "_section",
                                    'FieldType',
                                    $ini_object->get( $value, 'FieldType', '' )
                                );
                                $uninstall_ini->set(
                                    "delete_gff$gff_delfnum" . "_section",
                                    'Label',
                                    $ini_object->get( $value, 'Label', '' )
                                );
                                $uninstall_ini->set(
                                    "delete_gff$gff_delfnum" . "_section",
                                    'Value',
                                    $ini_object->get( $value, 'Value', '' )
                                );
                                $uninstall_ini->set(
                                    "delete_gff$gff_delfnum" . "_section",
                                    'StructIndex', $v[1] );
                                ...
                                ProcessMessage(
                                    Format(
                                        $Messages{LS_LOG_GFFNEWFIELDADDED},
                                        ( split( /\//, $answer[1] ) )[-1]
                                    ),
                                    LOG_LEVEL_INFORMATION
                                );
                        ...
                        if ( $skip == 0 ) {
                            ...
                            if ( $v[0] == 1 ) {
                                ...
                                ProcessMessage(
                                    Format(
                                        $Messages{LS_LOG_GFFMODIFIEDVALUE},
                                        $value,
                                        $key,
                                        ( split( /\//, $answer[1] ) )[-1]
                                    ),
                                ...
                                ProcessMessage(
                                    Format(
                                        $Messages{LS_LOG_GFFINCORRECTLABEL},
                                        $key,
                                        ( split( /\//, $answer[1] ) )[-1]
                                    ),
                                    LOG_LEVEL_ALERT
                    ...
                    if ( $changes > 0 ) {
                        ...
                        ProcessMessage(
                            Format(
                                $Messages{LS_LOG_GFFMODFIELDSUMMARY},
                                $changes,
                                ( split( /(\\|\/)/, $answer[1] ) )[-1]
                            ),
                            LOG_LEVEL_VERBOSE
                        ...
                        if ( $PatchType eq 'fileGFFERF' ) {
                            ...
                            if ( $answer[1] ne "$install_path/$ERF_name/"
                                . ( split( /(\\|\/)/, $answer[1] ) )[-1] )
                            {
                                File::Copy::copy( $answer[1],
                                    "$install_path/$ERF_name/"
                                      . ( split( /(\\|\/)/, $answer[1] ) )[-1]
                                );
                            }
                            ...
                            if (
                                (
                                    $answer[1] ne "$install_path/$ERF_name/"
                                    . ( split( /(\\|\/)/, $answer[1] ) )[-1]
                                )
                                && ( $InstallInfo{bInstall} == 1 )
                              )
                            {
                                unlink( $answer[1] );
                            }
                            ...
                            ProcessMessage(
                                Format(
                                    $Messages{LS_LOG_GFFSAVEINERFORRIM},
                                    ( split( /(\\|\/)/, $answer[1] ) )[-1],
                                    ( split( /(\\|\/)/, $Destination ) )[-1]
                                ),
                                LOG_LEVEL_INFORMATION
                            ...
                            ProcessMessage(
                                Format(
                                    $Messages{LS_LOG_GFFUPDATEFINISHED},
                                    ( split( /\//, $answer[1] ) )[-1]
                                ),
                                LOG_LEVEL_INFORMATION
                            );
                    ...
                    ProcessMessage(
                        Format( $Messages{LS_LOG_GFFNOMODIFIERS}, $filename ),
                        LOG_LEVEL_ALERT );
                }
            }
            else {
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_GFFCANTLOADFILE},
                        ( split( /\//, $answer[1] ) )[-1]
                    ),
                    LOG_LEVEL_ERROR
                );
            ...
            ProcessMessage(
                Format( $Messages{LS_LOG_GFFNOFILEOPENED}, $filename ),
                LOG_LEVEL_ALERT );
        }
    }
}
...
sub DeleteGFFField {
    ...
    if ( ( scalar @lines1 ) == 0 ) {
        ProcessMessage( Format( $Messages{LS_LOG_GFFSECTIONMISSING}, $section ),
            LOG_LEVEL_ALERT );
        return 0;
    }
    ...
    if ( $type eq FIELD_LIST ) {
        ...
        foreach ( @{ $struct->{Value} } ) {
            if ( $_->{StructIndex} == $index ) { $deleted = 1; }
            else                               { push( @$new, $_ ); }
        }
        $struct->{Value} = @$new;
    }
...
sub AddGFFField {
            ...
            if ( $pcounter == 0 ) {
                  ...
                  # if((scalar $struct->{Fields}) > 1)
                {
                    if ( ref( $struct->{Fields} ) eq 'ARRAY' ) {
                        ...
                        # print "1 ";
                        $struct = $struct->{Fields}
                          [ $struct->get_field_ix_by_label($_) ];
                        $stype = $struct->{Type};
    ...
    if ( GetIsStringToken($value) ) { $value = ProcessStrRefToken($value); }
    ...
    if ( $stype != FIELD_LIST ) {
        if ( $key eq '' ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_GFFMISSINGLABEL}, $section ),
                LOG_LEVEL_ALERT );
            return 0;
        }
        ...
        if ( $field ne undef ) {
            ...
            elsif ( ( $type eq 'Float' ) and ( $field->{Type} eq FIELD_FLOAT ) )
            {
                ...
                and ( $field->{Type} eq FIELD_DOUBLE ) )
            {
                $field->{Value} = $value;
            }
            elsif ( ( $type eq 'ExoString' )
                and ( $field->{Type} eq FIELD_CEXOSTRING ) )
            {
                $field->{Value} = $value;
            }
            elsif ( ( $type eq 'ResRef' )
                and ( $field->{Type} eq FIELD_RESREF ) )
            {
                $field->{Value} = $value;
            }
            elsif ( ( $type eq 'ExoLocString' )
                and ( $field->{Type} eq FIELD_CEXOLOCSTRING ) )
            {
                ...
                {
                    ProcessMessage(
                        Format( $Messages{LS_LOG_GFFINVALIDSTRREF}, $value ),
                        LOG_LEVEL_ALERT );
                    $value = -1;
                }
                ...
                and ( $field->{Type} eq FIELD_ORIENTATION ) )
            {
                $field->{Value} = split( /\|/, $value );
            }
            elsif ( ( $type eq 'Position' )
                and ( $field->{Type} eq FIELD_POSITION ) )
            {
                $field->{Value} = split( /\|/, $value );
            }
            elsif ( ( $type eq 'Struct' )
                and ( $field->{Type} eq FIELD_STRUCT ) )
            {
                $value = $ini_object->get( $section, 'TypeId', '' );

                if (    ( $stype == FIELD_LIST )
                    and ( lc($value) eq 'listindex' ) )
                {
                    $value = scalar @{ $struct->{Value} };
                }

                if ( looks_like_number($value) ) { $field->{'ID'} = $value; }
            }
                ...
                ProcessMessage(
                    Format( $Messages{LS_LOG_GFFLABELEXISTS}, $key, $ModPath ),
                    LOG_LEVEL_ALERT
                );
                return 0;
            }
            ...
            ProcessMessage(
                Format( $Messages{LS_LOG_GFFLABELEXISTSMOD}, $key, $ModPath ),
                LOG_LEVEL_INFORMATION );
            $modified = 1;
        }
    }
    ...
    if ( $modified == 0 ) {
        if ( $type eq 'Byte' ) {
            ...
            if ( looks_like_number($value) ) { $new_struct->{'ID'} = $value; }

            push( @{ $struct->{Value} }, $new_struct );
        }
        elsif ( $type eq 'List' ) { }    # Do nothing.
        else {
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_GFFINVALIDTYPEDATA},
                    $type, $section,
                    ( split( /(\\|\/)/, $gff->{filename} ) )[-1]
                ),
                LOG_LEVEL_ALERT
            );
            return 0;
            ...
            if ( $pcounter == 0 ) {
                  ...
                  # if((scalar $struct->{Fields}) > 1)
                {
                    ...
                    if ( $stype ne FIELD_STRUCT ) {
                        ...
                        # print "6 ";
                        $struct = $struct->{Fields}{Value}
                          [ $struct->{Fields}{Value}->get_field_by_label($_) ];
                        $stype = $struct->{Type};
                        if ( $struct->{Type} == undef or $struct->{Type} eq '' )
                        {
                            $stype = FIELD_STRUCT;
...
sub DoHACKList {
    ...
    foreach $index (@lines1) {
        ...
        if ( ( $filename ne '' ) and ( length($filename) > 4 ) ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_HAKMODIFYFILE}, $filename ),
                LOG_LEVEL_VERBOSE );
...
sub ProcessHACKFile {
    ...
    if ( ( scalar @data ) <= 0 ) {
        ProcessMessage( Format( $Messages{LS_LOG_HAKNOOFFSETS}, $filename ),
            LOG_LEVEL_ALERT );
        return;
    }
    ...
    if ( $answer[0] == 1 ) {
        ...
        if ( ( -e $file ) == 0 ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_HAKNOVALIDFILE}, $filename ),
                LOG_LEVEL_ERROR );
            return;
        }
        ...
        foreach $piece (@data) {
            ...
            if ( lc($piece) eq 'replacefile' ) {
                $uninstall_ini->set( $filename, $piece, $piece_value );
            }    # Do nothing.
            ...
            if (    ( $piece ne '' )
                and ( $piece_value ne '' )
                and ( looks_like_number($piece) )
                and ( looks_like_number($piece_value) ) )
            {
                if ( ( -s FH ) > $piece ) {
                    use bytes;
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_HAKMODIFYINGDATA},
                            ( split( /\//, $file ) )[-1],
                            $piece,
                            $piece_value
                        ),
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_HAKINVALIDOFFSET},
                        $piece,
                        $piece_value,
                        ( split( /\//, $file ) )[-1]
                    ),
...
sub DoCompileFiles {
    ...
    if ( ( -e "$base/tslpatchdata/nsstemp/" ) == 0 ) {
        make_path( "$base/tslpatchdata/nsstemp",
            { chmod => 0777, user => $user } );
    }

    my $NCSDestinsation =
      $ini_object->get( 'CompileList', '!DefaultDestination', 'override' );
    ...
    foreach $piece (@lines1) {
        ...
        if ( lc($piece) eq '!defaultdestination' ) { next; }    # Do nothing.
        ...
        if ( $answer[0] == 1 ) {
            ...
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_NCSPROCESSINGTOKENS},
                    ( split( /\//, $ScriptInfo{ModFile} ) )[-1]
                ),
                LOG_LEVEL_VERBOSE
            );
            ...
            $FileBase .=
              $ini_object->get( $piece_value, '!SaveAs', $piece_value );
            $FileBase =~ s/\.nss/\.ncs/;

            if (    ( ( -e $ScriptInfo{ModFile} ) == 1 )
                and ( $ScriptInfo{IsInclude} == 0 ) )
            {
                my $flags =
                  $ini_object->get( 'Settings', 'ScriptCompilerFlags', '' );
                if ( length($flags) > 0 ) {
                ...
                ProcessMessage(
                    Format(
                        $Messages{LS_LOG_NCSCOMPILINGSCRIPT},
                        ( split( /\//, $ScriptInfo{ModFile} ) )[-1]
                    ),
                    LOG_LEVEL_INFORMATION
                );
                ...
                ProcessMessage(
                    Format( $Messages{LS_LOG_NCSCOMPILEROUTPUT}, $string ),
                    LOG_LEVEL_VERBOSE );

                my $NCSFile = ( split( /\//, $FileBase ) )[-1];

                if ( -e $FileBase ) {    # "$base/tslpatchdata/$NCSFile")
                    my $dest = $ini_object->get( $piece_value, '!Destination',
                        $NCSDestinsation );
                    ...
                    if ( lc($dest) ne 'override' ) {
                        ...
                        if ( -e "$install_path/$ERF_name" ) {
                            if (
                                (
                                    ( -e "$install_path/$ERF_name/$NCSFile" )
                                    == 1
                                )
                                and ( $InstallInfo{Backups} = 1 )
                              )
                            {
                                MakeBackup( "$install_path/$ERF_name/$NCSFile",
                                    $ERF_name );
                            }
                              ...
                              )
                            {
                                ProcessMessage(
                                    Format(
                                        $Messages{LS_LOG_NCSFILEEXISTSKIP},
                                        ( split( /\//, $NCSFile ) )[-1],
                                        ( split( /\//, $dest ) )[-1]
                                    ),
                                    LOG_LEVEL_ALERT
                                ...
                                File::Copy::copy( $FileBase,
                                    "$install_path/$ERF_name/$NCSFile" );
                                unlink($FileBase);

                                HandleERFOverrideType( $NCSFile, $piece_value,
                                    0, $NCSDestinsation );
                            }
                        }
                        else {
                            ...
                            # Now pull everything into a sub-folder named
                            # after the level itself. This way we aren't
                            # having to deal with the data in memory...
                            $ERF_type =
                              substr( $ERF_name, ( length($ERF_name) - 3 ), 3 );
                            $ERF_name =
                              substr( $ERF_name, 0, ( length($ERF_name) - 4 ) );
                        ...
                        File::Copy::copy( $FileBase,
                            "$install_dest_path/override/$NCSFile" );
                        unlink($FileBase);
                    }
                }
                else {
                    ProcessMessage(
                        Format( $Messages{LS_LOG_NCSCOMPILEDNOTFOUND}, $file ),
                        LOG_LEVEL_ERROR
                    );
                }
            }
                ...
                if ( $ScriptInfo{IsInclude} == 1 ) {
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_NCSINCLUDEDETECTED},
                            ( split( /\//, $file ) )[-1]
                        ),
                        LOG_LEVEL_VERBOSE
                    );
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_NCSPROCNSSMISSING},
                            ( split( /\//, $file ) )[-1]
                        ),
                        LOG_LEVEL_ERROR
                    );
    ...
    foreach $file (@Orgs) {
        if ( $Debug == 1 ) {
            if ( -e "$install_path/debug" == 0 ) {
                make_path( "$install_path/debug",
                    { chmod => 0777, user => $user } );
            }
            File::Copy::copy(
                "$install_path/nsstemp/" . ( split( /\//, $file ) )[-1],
                "$install_path/debug/" .   ( split( /\//, $file ) )[-1]
            );
        }

        if ( -e $file ) {
            File::Copy::copy( $file,
                "$install_path/" . ( split( /\//, $file ) )[-1] );
            unlink($file);
        }
    }
...
sub ReplaceTokensInFile {
    my $file = shift;
    my $tmp_file =
      $base . "/tslpatchdata/nsstemp/" . ( split( /(\\|\/)/, $file ) )[-1];
...
sub DoSSFList {
    ...
    foreach $piece (@lines1) {
        ...
        if ( ( scalar @lines2 ) == 0 ) {
            ProcessMessage(
                Format( $Messages{LS_LOG_SSFNOMODIFIERS}, $piece_value ),
                LOG_LEVEL_ALERT );
            next;
        }
        ...
        if ( ( $piece_value ne '' ) and ( $answer[0] == 1 ) ) {
            ...
            if ( ( -e $file ) == 0 ) {
                ProcessMessage(
                    Format( $Messages{LS_LOG_SSFFILENOTFOUND}, $piece_value ),
                    LOG_LEVEL_ALERT );
                next;
            }

            ProcessMessage(
                Format( $Messages{LS_LOG_SSFMODSTRREFS}, $piece_value ),
                LOG_LEVEL_INFORMATION );
            ...
            foreach $key (@lines2) {
                ...
                if ( looks_like_number($value) ) {
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_SSFSETTINGENTRY},
                            $key, $value
                        ),
                        LOG_LEVEL_VERBOSE
                    );
                    ...
                    ProcessMessage(
                        Format(
                            $Messages{LS_LOG_SSFINVALIDSTRREF}, $key,
                            $value
                        ),
                        LOG_LEVEL_ALERT
                    );
            ...
            ProcessMessage(
                Format(
                    $Messages{LS_LOG_SSFUPDATESUMMARY}, $count,
                    $piece_value
                ),
                LOG_LEVEL_VERBOSE
            );
            ...
            ProcessMessage( Format( $Messages{LS_LOG_SSFNOFILE}, $piece_value ),
                LOG_LEVEL_ALERT );
        }
    }
}
...
sub DoCleanup {
    ...
    if ( ( scalar @ERFs ) > 0 ) {
        foreach ( sort @ERFs ) {
            ...
            if ( $IsERF == 1 ) {
                Bioware::ERF::make_new_from_folder(
                    "$install_path/$ERF_name2",
                    $ERF_type,
                    "$install_dest_path/$ERF_name/$ERF_name2\." . lc $ERF_type
                );
            }
            else {
                Bioware::RIM::make_new_from_folder( "$install_path/$ERF_name2",
                    "$install_dest_path/$ERF_name/$ERF_name2" . "_new\.rim" );
            }
        ...
        foreach $ERF_name (@ERF_delete) {
            ...
            @files =
              grep { -f } map { "$install_path/$ERF_name/$_" } readdir DIR;
            closedir DIR;
    ...
    if ( -e "$install_path\\erftemp" ) { rmdir("$install_path/erftemp"); }

    # File::Path::rmtree("$install_path/erftemp"); }

    if ( -e "$install_path\\nsstemp" ) { rmdir("$install_path/nsstemp"); }
    ...
    while (<FH>) {
        if ( $_ =~ /^\{\\rtf/ ) {
            ...
            foreach ( 0 .. ( scalar @font - 1 ) ) {
                ...
                # print "$_ $f\n";
                # TODO: This unshift call does nothing?
                # unshift(@font);
...
sub ProcessRTFLine {
    ...
    if ( $line =~ /(.*?)\\cf(\d*)(.*)/ ) {
        ...
        $line = substr( $line, 0, $index )
          . substr( $line, ( $index + $length ), ( length($line) - $index ) );
    ...
    if ( $line =~ /\\b/ ) {
        if ( $line =~ /(.*)\\b(\D*)\\b0(.*)/ ) {
            ...
            $line = substr( $line, 0, index( $line, '\b' ) )
              . substr(
                $line,
                ( index( $line, '\b' ) + 3 ),
                ( length($line) - index( $line, '\b' ) )
              );
        }
    ...
    if ( $line =~ /\\strike/ ) {
        if ( $line =~ /(.*)\\strike(.*)\\strike0(.*)/ ) {
            ...
            $line = substr( $line, 0, index( $line, '\strike' ) )
              . substr(
                $line,
                ( index( $line, '\strike' ) + 7 ),
                ( length($line) - index( $line, '\strike' ) )
              );
        }
    ...
    if ( $line =~ /\\i/ ) {
        if ( $line =~ /(.*)\\i(.*)\\i0(.*)/ ) {
            ...
            $line = substr( $line, 0, index( $line, '\i' ) )
              . substr(
                $line,
                ( index( $line, '\i' ) + 3 ),
                ( length($line) - index( $line, '\i' ) )
              );
        }
...
sub WriteRTFLine {
    ...
    #   . $ParaInfo{'colorfg'} . " CB: "
    #   . $ParaInfo{'colorbg'} . "\n\n";
    $GUI->{'mwInfoText'}->tagConfigure(
        'Tag' . $tag,
        -background => $colorsbg[ $ParaInfo{'colorbg'} ],
        -foreground => $colorsfg[ $ParaInfo{'colorfg'} ],
        -font       => [
            -weight     => $FontInfo{'weight'},
            -slant      => $FontInfo{'slant'},
            -underline  => $FontInfo{'underline'},
            -overstrike => $FontInfo{'overstrike'},
            -family     => $FontInfo{'family'},
            -size       => $FontInfo{'size'}
        ],
        -spacing1  => $ParaInfo{'spacing1'},
        -spacing3  => $ParaInfo{'spacing3'},
        -underline => $FontInfo{'-underline'},
        -justify   => $ParaInfo{'align'}
    );
    push( @tags, 'Tag' . $tag );
